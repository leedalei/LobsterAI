...
contextBridge.exposeInMainWorld('electron', {
  ...
  cowork: {
    ...
    saveSessionExport: (options: { format: 'markdown' | 'pdf'; content: string; htmlContent?: string; defaultFileName?: string }) =>
      ipcRenderer.invoke('cowork:session:saveExport', options),
