...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkExportDialogTitle: '导出会话',
    coworkExportDialogDescription: '导出当前会话为 Markdown 或 PDF 文件，仅保留用户与 LobsterAI 的正文对话。',
    coworkExportFileName: '文件名',
    coworkExportFormatLabel: '格式',
    coworkExportFormatMarkdown: 'Markdown (.md)',
    coworkExportFormatPdf: 'PDF (.pdf)',
    coworkExportConfirm: '导出',
    coworkExportSubmitting: '导出中...',
    coworkExportSessionSuccess: '会话导出成功',
    coworkExportSessionFailed: '导出会话失败',
    coworkExportSessionLoadFailed: '读取会话内容失败，无法导出',
  ...
  en: {
    ...
    coworkExportDialogTitle: 'Export Session',
    coworkExportDialogDescription: 'Export this session as a Markdown or PDF file with only user and LobsterAI conversation content.',
    coworkExportFileName: 'File name',
    coworkExportFormatLabel: 'Format',
    coworkExportFormatMarkdown: 'Markdown (.md)',
    coworkExportFormatPdf: 'PDF (.pdf)',
    coworkExportConfirm: 'Export',
    coworkExportSubmitting: 'Exporting...',
    coworkExportSessionSuccess: 'Session exported successfully',
    coworkExportSessionFailed: 'Failed to export session',
    coworkExportSessionLoadFailed: 'Failed to load session content for export',
